param(
  [double]$SigmaSpread    = 13,
  [double]$SigmaTotal     = 10,
  [double]$MinEvSpread    = 0.015,
  [double]$MinEdgeSpread  = 1.2,
  [double]$KellyFrac      = 0.12,
  [double]$PerBetCap      = 0.006,
  [double]$WeeklyCap      = 0.05,
  [double]$PauseDD        = 0.30
)

$py = ".\.venv\Scripts\python.exe"

# 1) Predict with Phase-6 ensemble (v5 features)
...
# 3) Bankroll with your winning gates
...
Write-Host "[OK] Phase-6 best-run completed."
